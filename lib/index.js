...
var Recloud = {
  ...
  componentWillMount: function() {
    ...
    if (!this.loadData) {
      throw new Error('Components using Recloud must declare a loadData() method.');
    }
  ...
  _unsubscribe: function() {
    /* Do something else here if Promise ever becomes cancellable. */
    this._subscriptions = {};
  },
  _getData: function(fxn, fxnObj) {
    ...
    //load the data from user-defined function
    return fxnObj.load().then(function(result) {
